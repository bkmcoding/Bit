...
export function ChapterMapScreen({ onContinue }: Props) {
  return (
    ...
    >
      <div
        className="max-w-lg w-full rounded border p-6 font-mono text-sm"
        style={{
      ...
      >
        ...
        <h2 className="mt-2 text-lg text-[#d4f4ff] tracking-wide">The Flooded Depths</h2>
        <p className="mt-3 leading-relaxed text-[#8aa8b0]">
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          ...
          >
            ...
            <div className="mt-1 text-[12px] text-[#c0e8dc]">
          ...
          >
            ...
            <div className="mt-1 text-[12px] text-[#f0d0dc]">
